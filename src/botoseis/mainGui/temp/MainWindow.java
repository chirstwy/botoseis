...
//        panelWorkflow.add(m_workflowView);
    ...
    private void initComponents() {
        ...
        flowsPanel = new javax.swing.JDesktopPane();
        ...
        panelW.setLayout(new java.awt.GridLayout(1, 0));

        jTabbedPane1.addTab("Flows", flowsPanel);

        panelW.add(jTabbedPane1);
        ...
        jPanel16Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                ...
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(m_processOutputTab, javax.swing.GroupLayout.DEFAULT_SIZE, 804, Short.MAX_VALUE)
        ...
        jPanel16Layout.setVerticalGroup(
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                ...
                .addComponent(m_processOutputTab, javax.swing.GroupLayout.PREFERRED_SIZE, 58, Short.MAX_VALUE))
        );
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(labelProjectExplorer, javax.swing.GroupLayout.DEFAULT_SIZE, 226, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel5.add(comboProcessesList, java.awt.BorderLayout.PAGE_END);
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGap(138, 138, 138)
                        .addComponent(jPanel8, javax.swing.GroupLayout.PREFERRED_SIZE, 611, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
            .addComponent(jPanel9, javax.swing.GroupLayout.DEFAULT_SIZE, 1076, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jPanel8, 0, 0, Short.MAX_VALUE)
...
private void btnMoveTopActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMoveTopActionPerformed
    if (m_currentWorkflow != null) {
        ...
        m_workflowView.setSelectedProcess(0);
    }
...
private void btnMoveUPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMoveUPActionPerformed
    if (m_currentWorkflow != null) {
        ...
        m_workflowView.setSelectedProcess((i - 1) == -1 ? 0 : i - 1);
    }
...
private void btnMoveDownActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMoveDownActionPerformed
    if (m_currentWorkflow != null) {
        ...
        m_workflowView.setSelectedProcess((i + 1) == m_workflowView.getSizeProcessList() ? m_workflowView.getSizeProcessList() - 1 : i + 1);
    }
...
private void btnMoveBottomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMoveBottomActionPerformed
    if (m_currentWorkflow != null) {
        ...
        m_workflowView.setSelectedProcess(m_workflowView.getSizeProcessList() - 1);
    }
}//GEN-LAST:event_btnMoveBottomActionPerformed

private void btnRunActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRunActionPerformed
    if (flowsPanel.getSelectedFrame() != null) {
        m_currentWorkflow = ((FlowWindow) flowsPanel.getSelectedFrame()).getWorkflowView().getModel();
    } else {
        if (flowsPanel.getAllFrames().length > 0) {
            m_currentWorkflow = ((FlowWindow) flowsPanel.getAllFrames()[0]).getWorkflowView().getModel();
        } else {
...
// TODO add your handling code here:
    ...
    largura = largura - 800;
    jSplitPane2.setDividerLocation(largura);
...
//                m_currentWorkflow = null;
                ...
                if (n.getUserObject() instanceof botoseis.mainGui.workflows.WorkflowModel) {
                    ...
                    if (m_currentWorkflow != null) {
                        FlowWindow fw = null;
                        fw = getMapFlowWindow().get(n);

                        if (fw == null) {
                            fw = new FlowWindow(m_activeProject.getTitle() + " - " + m_currentWorkflow.getTitle(), this);
                            fw.getWorkflowView().setModel(m_activeProject.selectWorkflow(n.getUserObject().toString()));
                            fw.setSize(new Dimension(200, 300));
                            fw.updateUI();
                            fw.setOpen(true);

                            flowsPanel.add(fw);

                            flowsPanel.getDesktopManager().openFrame(fw);
                            flowsPanel.revalidate();
                            getMapFlowWindow().put(n, fw);
                        } else {
                            flowsPanel.getDesktopManager().openFrame(fw);
                            flowsPanel.revalidate();
                        }
...
//                m_workflowView.setModel(m_currentWorkflow);
    ...
    public JDesktopPane getFlowsPanel() {
        return flowsPanel;
    }

    public void setCurrentFlow(WorkflowView view) {
        m_currentWorkflow = view.getModel();
        m_workflowView = view;
    ...
    private javax.swing.JDesktopPane flowsPanel;
...
//            DefaultNode root = (DefaultNode) tm.getRoot();
    ...
    /**
     * @return the mapFlowWindow
     */
    public HashMap<DefaultNode, FlowWindow> getMapFlowWindow() {
        return mapFlowWindow;
    }

    /**
     * @param mapFlowWindow the mapFlowWindow to set
     */

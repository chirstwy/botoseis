...
public class EditProcessDlg extends javax.swing.JDialog {
    ...
    public EditProcessDlg(java.awt.Frame parent, boolean modal) {
        ...
        prmList.addTreeSelectionListener(this::prmListValueChanged);
    ...
    public void setParameters(List<ParametersGroup> pg) {
        DefaultMutableTreeNode root = new DefaultMutableTreeNode("Groups");
        m_treeModel = new DefaultTreeModel(root);
        ...
        for (int i = 0; i < pg.size(); i++) {
            ...
            List<ProcessParameter> plist = g.getParameters();
    ...
    public List<ParametersGroup> getParameters() {
        List<ParametersGroup> res = new ArrayList<>();

...
public class WorkflowLogDlg extends javax.swing.JFrame {
    ...
    public boolean checkError() {
        return taOutput.getText().toLowerCase().contains(".c") || taOutput.getText().toLowerCase().contains("error") || taOutput.getText().toLowerCase().contains("exception") || taOutput.getText().toLowerCase().contains("can't");
    }

    public void salveLog(String string) {
        try (BufferedWriter buff = new BufferedWriter(new FileWriter(string))) {

...
public class Document extends PlainDocument {
    ...
    public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
        ...
        if (item != null) {
            ...
            getLookAndFeel().provideErrorFeedback(adaptor.getTextComponent());
        } else {
     ...
     * AbstractComponentAdaptor is used to access the candidate items. The match
    ...
    /**
     * Returns true if <code>string1</code> starts with <code>string2</code>
     * (ignoring case).
     *
     * @param string1 the first string
     * @param string2 the second string
     * @return true if <code>string1</code> starts with <code>string2</code>;
     * false otherwise
     */
